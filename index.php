...
$.ajax({
    url: 'https://api.dribbble.com/v2/user/shots?access_token='+/*'<?= getenv('accessToken') ?>'*/'1058de76e6f55a4ba73ba03c7720a793966988428b151b9471905292ef85bd2c'+'&per_page=100',
    dataType: 'json',
    type: 'GET',
    success: function(data) {
        if (data.length > 0) {
